 ...
 mutations: {
  ...
  addToMyList(state, payload) {
   if (localStorage.getItem("myList") === null) {
    ...
    myListLocalStorage = myListLocalStorage.concat(JSON.parse(localStorage.getItem("myList")));
  ...
  removeFromMyList(state, payload) {
   ...
   const idIndex = localStorageList.map((object) => object.id).indexOf(payload);
