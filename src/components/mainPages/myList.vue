<template>
 <div v-if="this.myListLocal !== null" class="mylistContainer">
  <ul>
   <li v-for="item of this.myListLocal" :key="item" class="card carouselList" :id="item.id">
    <img v-bind:src="'http://image.tmdb.org/t/p/w185' + item.backdrop_path" />
    <h4>{{ item.title }}</h4>
