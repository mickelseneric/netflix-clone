<template>
 <div class="fullCarousel">
  <div class="listElement">
   <h1 class="listTitle">Top Rated</h1>
   <div class="carousel" id="topRatedCarousel">
...
export default {
 ...
 methods: {
  async checkItOut() {
   const res = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=fa73fbb2a48739b593cdcc467151fa54&language=en-US`);
