<template>
 <div class="fullCarousel">
  <div class="listElement">
   <h1 class="listTitle">Thriller</h1>
...
export default {
 ...
 methods: {
  async checkItOut() {
   const res = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=fa73fbb2a48739b593cdcc467151fa54&with_genres=53`);
